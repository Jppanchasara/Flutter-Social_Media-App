    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          bodyText2: TextStyle(fontSize: 17,fontFamily: AppFonts.sfProDisplayRegular,color: AppColors.primaryTextTextColor,height: 1.6),
          caption: TextStyle(fontSize: 14,fontFamily: AppFonts.sfProDisplayBold,color: AppColors.primaryTextTextColor,height: 2.26),
